...
function CurrentWeather({ city, temp, feelsLike, dt, description, icon }) {
    ...
    return (
        <div
            className=" flex flex-col justify-center items-center py-14 text-white"
            style={{
                backgroundImage: `url(/assets/images/${icon}.jpg)`,
                backgroundSize: "cover",
            }}
        >
            <h1 className="text-4xl mb-2 h-11 uppercase font-title mt-4 txt-shadow">
                {city}
            </h1>
            <p className="text-2xl font-body mb-1 txt-shadow">{time}</p>
            <img
            ...
            <div className="flex flex-row justify-center ">
                <p className="text-8xl font-title txt-shadow">{temp}</p>
